...
The immediate testing-environment milestone is implemented:
...
DEV001 still requires its targeted cross-layout generated-prop/floor-prop regression test. Once that passes, the gate is complete and t007 becomes Ready.

This is a development gate, not a change to the player-facing gameplay loop.

### t007 — Adventurer Loot Drop & Dungeon Recovery
**Status:** Planned / Next after tooling validation
...
Depends on: t006 and completion of the DEV001–DEV003 tooling gate.
